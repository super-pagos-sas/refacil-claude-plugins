# specs: feat-cowork-marketplace

## CA-01: marketplace.json con campos requeridos
...
## CA-02: plugin.json con campos requeridos
...
## CA-03: La skill vendorizada apunta al CLI global sin reimplementar lógica
...
## CA-04: SKILL.md y references/ son copia exacta del paquete npm publicado
...
## CA-05: references/ completo y con rutas relativas resueltas
...
## CA-06: README documenta prerequisito e instrucciones de instalación CLI
...
## CA-08: README documenta el modelo de actualizaciones (dos capas)
...
## CA-07: Estructura reconocible por /plugin marketplace add
...
## CR-01: Skills colocadas dentro de .claude-plugin/
...
## CR-02: SKILL.md o references/ editados a mano
...
## CR-03: references/ omitido o incompleto
...
## CR-04: marketplace.json o plugin.json con campos faltantes
...
## CR-05: Flujo de instalación Claude Desktop/Cowork documentado sin verificación en vivo [RIESGO DOCUMENTAL]
